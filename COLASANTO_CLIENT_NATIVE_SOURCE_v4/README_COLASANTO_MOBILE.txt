...
VERSIONE 2.1.0 - LOGIN NATIVO
- Login Android/iOS usa direttamente numero telefono + PIN.
- Non richiede più il token invito del link WhatsApp.
- Backend RPC: client_native_login.
