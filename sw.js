const CACHE='colasanto-client-github-v1';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./manifest.webmanifest','./icon-192.jpg','./icon-512.jpg'])).catch(()=>{}))});
